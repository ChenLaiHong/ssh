...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminPicture_save.action" method="post" enctype="multipart/form-data">
			&nbsp;
